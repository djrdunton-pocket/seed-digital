        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-[#f5f0e8]/50 leading-relaxed">Fixed-price websites for Bath businesses.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-[#f5f0e8]/30">Bath, UK</p>
            </div>
          </div>
          <div className="border-t border-[#f5f0e8]/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-[#f5f0e8]/30">© 2025 Seed Digital. All rights reserved.</p>
            <p className="text-xs text-[#f5f0e8]/30">Bath, UK · seed-digital.ai</p>
          </div>
        </div>
      </footer>
    );
