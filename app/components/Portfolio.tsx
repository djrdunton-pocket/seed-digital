      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-16">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-xs tracking-[0.2em] uppercase text-[#1a3a2a]/50">Our work</span>
          </div>
          <h2 className="font-fraunces text-4xl md:text-5xl font-light text-[#1a3a2a]">Built by Seed Digital</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <a href="https://www.steepteas.co.uk" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <h3 className="font-fraunces text-xl text-[#1a3a2a] mb-2">Steep Teas</h3>
          ...
          <a href="https://www.pocketbuilder.co.uk" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <h3 className="font-fraunces text-xl text-[#1a3a2a] mb-2">Pocket Builder</h3>
